class Solution:
    def numberToWords(self, num: int) -> str:
        names = {1000000000: 'Billion', 1000000: 'Million', 1000: 'Thousand', 100: 'Hundred', 90: 'Ninety', 80: 'Eighty', 
        ...
        for key,value in names.items():
            ...
            if num >= key:
                count = num//key
                num = num % key
                if count > 1 or key >=100 :
                    result = result + " "+ self.numberToWords(count)+ " "+ value
                else:
                    result = result + " " + value
        return result[1:]
